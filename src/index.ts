...
// TODO: добавить еще одно действие на развилке
...
// TODO: если GameOver, то не выводить доступные действия (хотя тут нужно подумать и сначала реализовать переход в состояние меню)